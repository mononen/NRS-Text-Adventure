...
class Inventory
    {
        ...
        public static void ItemStatusPrint()
        {
            ...
            if (flask)
            {
            	System.out.println("a flask,");
            }
            if (sack)
            {
            	System.out.println("a sack,");
            }
            if (bottle)
            {
            ...
            if(rug)
            {
            	System.out.println("a rug,");
            }
            if (Nmm)
            {
            	System.out.println("a 9mm pistol,");
            }
            if(NmmR > 0)
            {
            	System.out.println(NmmR + " rounds");
            }
            if (FlareGun)
            {
            	System.out.println("a flare gun,");
            }
            if(Flare > 0)
            {
            	System.out.println(Flare + " flares");
            }
        }
    }
    class Desc
    ...
    class Skip
    {
        public static void s()
        {
            ...
            if (KeyIn.equals("inymph1"))
            {
                ...
                Fight(Inventory.Nymph1HP, Inventory.Nymph1DMG, "Nymph", Inventory.Nymph1Alive);
            }
            else
            {
